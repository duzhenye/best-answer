...
class NotifyCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'duzhenye:best-answer:notify';
    ...
    {
        $days = (int) $this->settings->get('duzhenye-best-answer.select_best_answer_reminder_days');
        $canSelectOwn = (bool) (int) $this->settings->get('duzhenye-best-answer.allow_select_own_post');
